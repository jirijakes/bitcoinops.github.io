...
BitGo [launched][bitgo blog taproot] the first Tapscript multi-sig wallet and made the [first Tapscript
multi-sig transaction][] on mainnet. Nearly two years later, MuSig2 is specified in
[BIP327][], and we [launched][bitgo blog musig2] the first MuSig Taproot multi-sig wallet.

## Why MuSig2?

### Compared to Script Multi-sig

There are two main
benefits of MuSig compared to script multi-sig. The first and most obvious
benefit is a reduced transaction size and miner fee. On-chain signatures are
...
[first Tapscript multi-sig transaction]: https://mempool.space/tx/905ecdf95a84804b192f4dc221cfed4d77959b81ed66013a7e41a6e61e7ed530
