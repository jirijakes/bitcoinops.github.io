---
title: 'Zpravodaj „Bitcoin Optech” č. 403'
permalink: /cs/newsletters/2026/05/01/
name: 2026-05-01-newsletter-cs
slug: 2026-05-01-newsletter-cs
type: newsletter
layout: newsletter
lang: cs
---
...
- **Post-quantum HD wallets with fallback SPHINCS keys:** Conduition popsal
  v [příspěvku][c ml pq bip32] v emailové skupině Bitcoin-Dev návrh
  na [postkvantové][topic quantum resistance] [hierarchické deterministické
  peněženky][topic bip32] kompatibilní s [BIP32][] a s alternativními
  [SPHINCS][news383 sphincs] klíči. Tento návrh nahrazuje derivování odvozených
  klíčů dle BIP32 generováním SPHINCS klíčů vedle [secp256k1][secp256k1] klíčů.
  Kvůli chybějící algebraické vazbě uvnitř SPHINCS kličů sdílejí odvozené
  nehardened klíče stejné SPHINCS klíče jako jejich předkové a sourozenci.
  To po peněženkách vyžaduje vložit
